...
1. **회원가입**  
   ![회원가입 및 로그인](./gif/회원가입.gif)

2. **로그인**
     ![회원가입 및 로그인](./assets/signup-login.gif)

3. **게시글 작성, 수정, 삭제**  
   ![게시글 관리](./assets/post-management.gif)

4. **게시글 검색**  
   ![게시글 검색](./assets/search.gif)

5. **댓글 작성 및 삭제**  
   ![댓글 관리](./assets/comment-management.gif)

6. **페이지네이션**  
   ![페이지네이션](./assets/pagination.gif)
